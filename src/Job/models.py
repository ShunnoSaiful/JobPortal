...
class Job(models.Model):
    ...
    job_resposibility     = models.CharField(max_length=500, null=True, blank=True)
    employment_status     = models.CharField(max_length=500, null=True, blank=True)
    ...
    application_deadline  = models.DateField(auto_now=True, auto_now_add=False)
